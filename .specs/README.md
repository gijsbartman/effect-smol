...
- [response-id-tracking.md](response-id-tracking.md) - Add per-client response ID tracking with `prepare` method for incremental input mode in OpenAI providers.
